                ...
                VStack(alignment: .center, spacing: 0, content: {
                    ...
                    Group(content: {
                        HStack(alignment: .bottom, spacing: 0, content: {
                            ...
                            Spacer()
                            Text(String(format: "%d", data.shiftWorked))
                    ...
                    Group(content: {
                        HStack(alignment: .bottom, spacing: 0, content: {
                            Text(bundle: .CoopHistory_DefeatBossCount)
                                ...
                                .frame(height: 30, alignment: .top)
                            Spacer()
                            Text(String(format: "%d", data.bossKillCounts))
                                .font(systemName: .Splatfont2, size: 13)
                                .foregroundColor(Color.black)
                                .frame(height: 30, alignment: .bottom)
                        })
                    ...
                    Group(content: {
                        HStack(alignment: .bottom, spacing: 0, content: {
                            Text(bundle: .Common_Death_Count)
                                .font(systemName: .Splatfont2, size: 11)
                                .foregroundColor(Color.black.opacity(0.6))
                                .lineLimit(1)
                                .padding(.trailing, 4)
                                ...
                                .frame(height: 30, alignment: .top)
                            Spacer()
                            Text(String(format: "%d", data.deathCount))
                                .font(systemName: .Splatfont2, size: 13)
                                .foregroundColor(Color.black)
                                .frame(height: 30, alignment: .bottom)
                        })
                    ...
                    Group(content: {
                        HStack(alignment: .bottom, spacing: 0, content: {
                            Text(bundle: .CoopHistory_TotalPoint)
                                ...
                                .frame(height: 30, alignment: .top)
                            Spacer()
                            Text(String(format: "%d", data.kumaPoint))
                                .font(systemName: .Splatfont2, size: 13)
                                .foregroundColor(Color.black)
                                .frame(height: 30, alignment: .bottom)
                        })
